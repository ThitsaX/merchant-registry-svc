/* eslint-disable */
/**
 * ISO 18245 merchant category codes used for merchant classification.
 * Data derived from python-iso18245 v1.4.1 (MIT), official MCC list.
 * https://github.com/jleclanche/python-iso18245
 */
export const MerchantClassificationCodes: Readonly<Record<string, string>> = {
  ...
  "5813": "Drinking places (alcoholic beverages) -- bars, taverns, night-clubs, cocktail lounges and discotheques",
...
export function isMerchantClassificationCode (value: string): boolean {
  return Object.prototype.hasOwnProperty.call(MerchantClassificationCodes, value)
}
